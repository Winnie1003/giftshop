...
?>
	...
	<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_31839400_1461930661');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_31839400_1461930661']):
?>
	<dl>
		<dt><?php echo htmlspecialchars($this->_var['filter_attr_0_31839400_1461930661']['filter_attr_name']); ?> :</dt>
		<dd>
		    <?php $_from = $this->_var['filter_attr_0_31839400_1461930661']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
