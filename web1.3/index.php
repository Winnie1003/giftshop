...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
	...
	//首页调用指定热销商品
	$children = get_children(19);
  	$smarty->assign('index_best_goods_19', get_category_recommend_goods("best", $children)); // 热销商品
	//首页调用指定文章
	$smarty->assign('personal',get_cat_articles(13,1,8));//4代表id，1代表排，8代表文章个数
