...
?>
		...
		<li>                <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " class="f6"><?php echo $this->_var['lang']['drop']; ?></a>
...
<div id="order_end">
	...
	<p> 
		<a href="./"  class="go"><img src="themes/default/images/contin.png" /></a>
		<a href="flow.php?step=checkout" class="end"><img src="themes/default/images/pay.png" /></a>
	</p>
<div style="clear:both;" ></div>
</form>
</div>
...
<div id="LoginAndRegister">
	<p class="tit"> <span class="active">用户登录</span> <span>用户注册</span> </p>
    <div class="Con">

		
		<div class="Login">
			<form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
				<p><span>用户名：</span><input name="username" type="text" class="inputBg txt" id="username" />  </p>
				<p><span>密  码：</span><input name="password" class="inputBg txt" type="password txt" />  </p>
				...
				<p><span></span> 
                <input type="checkbox" value="1" name="remember" id="remember 	ck" /> <label for="ck">请保存我这次的登录信息</label></p>
				<P> 
                        <input type="submit" class="bnt_blue but" name="login" value="<?php echo $this->_var['lang']['forthwith_login']; ?>" style="cursor:pointer;"/>
                        <?php if ($this->_var['anonymous_buy'] == 1): ?>
                        <input type="button" class="bnt_blue_2 but but2" value="允许未登录购买" onclick="location.href='flow.php?step=consignee&amp;direct_shopping=1'" style="cursor:pointer;" />
                        <?php endif; ?>
                        <input name="act" type="hidden" value="signin" />

				</p>
				<p class="txt"><a href="user.php?act=qpassword_name" class="findpwd">密码问题找回密码</a> <a href="user.php?act=get_password">注册邮件找回密码</a></p>
		...
		<div class="Register">
			<form action="flow.php?step=login" method="post" name="formUser" id="registerForm" onsubmit="return checkSignupForm(this)">
				<p>	<span>用户名：</span><input name="username" type="text" class="inputBg txt" id="username" onblur="is_registered(this.value);" />
					<label id="username_notice" style="color:#FF0000"></label> 
				</p>

				<p>	<span>邮箱：</span><input name="email" type="text" class="inputBg txt" id="email" onblur="checkEmail(this.value);" />
					<label id="email_notice" style="color:#FF0000"></label>  
				</p>

				<p>	<span>密码：</span><input name="password" class="inputBg txt" type="password" id="password1" onblur="check_password(this.value);" onkeyup="checkIntensity(this.value)" />
            <label style="color:#FF0000" id="password_notice"></label>
				</p>
				<p>	<span>确认密码：</span><input name="confirm_password" class="inputBg txt" type="password" id="confirm_password" onblur="check_conform_password(this.value);" />
            <label style="color:#FF0000" id="conform_password_notice"></label>  
				...
				<p><input type="submit" name="Submit" class="bnt_blue_1 but" value="<?php echo $this->_var['lang']['forthwith_register']; ?>" style="cursor:pointer;"/></p>
                <p><input name="act" type="hidden" value="signup" /></p>
			</form>
