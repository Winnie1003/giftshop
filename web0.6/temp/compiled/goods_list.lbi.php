...
?>
    <?php if ($this->_var['goods']['goods_id']): ?>
	  <li>
			...
			<h3 class="showtit"><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo $this->_var['goods']['goods_name']; ?></h3>
			<p>
            <?php if ($this->_var['show_marketprice']): ?>
            <!--<?php echo $this->_var['lang']['market_prices']; ?><span style="display:none"><?php echo $this->_var['goods']['market_price']; ?></span>-->
            <?php endif; ?>
            <?php if ($this->_var['goods']['promote_price'] != ""): ?>
            ...
            <?php endif; ?>
          	<a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)">立即购买</a></p>
