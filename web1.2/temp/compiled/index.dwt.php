        ...
        <div class="partCon">
			...
			<div class="news">
				...
				<div class="newsKx">
					...
					<ul>
					  <?php $_from = $this->_var['flwenz1']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'art');if (count($_from)):
 ...
 <div class="Louti">
  ...
  <div id="Personal">
		...
		<div class="con">
			...
			<div class="partR">
			      <?php echo $this->fetch('library/index_best_goods_23.lbi'); ?>
